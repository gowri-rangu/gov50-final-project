...
The sample in this study is the House of Representatives from the 113th United States Congress, and the unit of analysis is each representative that voted on the NSA amendment. There are two explanatory variables of interest that will be tested: the representative’s party affiliation and funding from the private defense industry. The outcome variable is whether or not the representative voted for or against the continuation of NSA surveillance on American citizens. These variables were taken from the actual vote on the amendment and compiled into a dataset by the nonprofit research organization MapLight. To provide support for my hypothesis, a stronger, positive relationship between campaign financing and votes for mass surveillance must be observed compared to the relationship between party identity and votes. On the other hand, a weak or neutral relationship between sponsorships and votes supporting the amendment and/or a stronger relationship between party identity and votes would provide evidence against my hypothesis. Thus, with a regression analysis of the count of votes for rejecting the NSA amendment on the private defense funding and party identity indicator variable, a positive, higher coefficient for the funding variable would support my hypothesis. 
